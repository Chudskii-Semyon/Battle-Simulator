...
import { Squad as SquadEntity } from '../../entities/squad';
// import { Vehicle } from '../../entities/vehicle.entity';
// import { Soldier } from '../../entities/soldier.entity';
// import { Operator } from '../../entities/operator.entity';
import { max, min, sum, sumBy } from 'lodash';
...
import {
  CalculateBaseAttackDamageVisitor,
  CalculateBaseAttackSuccessVisitor,
  InflictBaseDamageVisitor,
  Soldier,
  Squad,
  Vehicle,
} from './composite';
